...
// Importar el componente de vista
import { UserTableView } from "../components/user-tableView";
...
export function UserTableContainer() {
  ...
  // 3. Renderizado: Pasa el estado a la vista
  return <UserTableView users={users} isLoading={isLoading} error={error} />;
}
